...
import { C as unescapeHTML, T as createAstro, _ as addAttribute, a as Fragment, c as renderSlot, d as renderTemplate, g as renderHead, i as renderComponent, v as createRenderInstruction } from "./server_ByxJykQl.mjs";
...
var pwaInfo = {
	...
	"registerSW": {
		...
		"type": "classic",
		"scope": "/",
		"scriptTag": "<script id=\"vite-plugin-pwa:register-sw\" src=\"/registerSW.js\"><\/script>"
	}
};
//#endregion
